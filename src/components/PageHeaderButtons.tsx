...
const PageHeaderButtons = ({openModalSortHandler, openModalFilterHandler}: PropsTypes) => {
    return (
        <>
            <button className='hidden md:flexx  border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 rounded-md py-2 px-3 text-sm' onClick={openModalSortHandler}>
